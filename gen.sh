...
git show master:README.md|marked --gfm| \
  sed -e 's/<li>\[ \] /<li class="no-bullet"><input type="checkbox" class="task-list-item-checkbox" checked="checked" disabled="disabled">\&nbsp;/g
