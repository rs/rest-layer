...
type Storer interface {
	...
	Find(ctx context.Context, lookup *Lookup, page, perPage, offset int) (*ItemList, error)
...
func (s storageWrapper) Find(ctx context.Context, lookup *Lookup, page, perPage, offset int) (list *ItemList, err error) {
	if s.Storer == nil {
		return nil, ErrNoStorage
	}
	if mg, ok := s.Storer.(MultiGetter); ok {
