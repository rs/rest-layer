...
type ResponseSender interface {
	...
	SendItem(ctx context.Context, headers http.Header, i *Item, skipBody bool) (context.Context, interface{})
	// SendItem formats a list of items in a format ready to be serialized by Send
	SendList(ctx context.Context, headers http.Header, l *ItemList, skipBody bool) (context.Context, interface{})
}
...
func (s DefaultResponseSender) SendList(ctx context.Context, headers http.Header, l *ItemList, skipBody bool) (context.Context, interface{}) {
	if l.Total >= 0 {
